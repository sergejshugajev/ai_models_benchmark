...
Если модель не найдена, её имя неоднозначно или номер теста неверен, программа покажет причину и не перейдёт к ручному выбору.
...
Второй вариант сохраняет исходные JSON-события OpenCode.
...
В комплект входят семь заданий возрастающей сложности:

1. простая Python-функция;
2. поиск и исправление ошибок;
3. упрощение кода по KISS/YAGNI;
4. создание небольшого законченного проекта;
5. агентная дисциплина, ограничения и cleanup;
6. системное ревью в роли технического руководителя;
7. длинная автономная работа с файлами, состоянием и бизнес-правилами.

Правила независимой оценки описаны в [руководстве оценщика](ai_models_benchmark_evaluator_guide.md), а назначение и особенности каждого задания — в [анализе тестового набора](ai_models_benchmark_tests_analysis.md).
